...
echo_and_run cd "/home/ucar/cvbridge_py3/src/vision_opencv/image_geometry"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/ucar/cvbridge_py3/src/vision_opencv/image_geometry/setup.py" \
    build --build-base "/home/ucar/cvbridge_py3/build/vision_opencv/image_geometry" \
    install \
    $DESTDIR_ARG \
